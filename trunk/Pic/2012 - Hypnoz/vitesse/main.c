...
// Définition des constantes caractéristiques du capteur de vitesse
...
// Variables globales
int8 speedL=0; 				    // donnée après calcul
int8 speedR=0; 					// donnée après calcul

unsigned int16 msL=0;           // pour les mesures de vitesse à gauche
unsigned int16 msR=0;		    // pour les mesures de vitesse à droite
