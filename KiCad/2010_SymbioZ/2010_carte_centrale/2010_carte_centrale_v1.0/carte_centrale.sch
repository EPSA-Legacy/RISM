...
LIBS:power,device,conn,linear,regul,74xx,cmos4000,adc-dac,memory,xilinx,special,microcontrollers,analog_switches,motorola,intel,audio,interface,digital-audio,philips,display,cypress,siliconi,contrib,./carte_centrale.cache
EELAYER 23  0
EELAYER END
$Descr A4 11700 8267
Sheet 1 1
...
Comment4 ""
$EndDescr
Kmarq B 9300 1400 "Warning Pin input non pilotée (Net 37)" F=1
Kmarq B 9000 4800 "Warning Pin input non pilotée (Net 35)" F=1
Kmarq B 9000 4900 "Warning Pin input non pilotée (Net 34)" F=1
Kmarq B 9300 1550 "Warning Pin input non pilotée (Net 18)" F=1
Kmarq B 9300 1700 "Warning Pin input non pilotée (Net 17)" F=1
Wire Wire Line
	10050 6300 7500 6300
NoConn ~ 7350 2150
NoConn ~ 7350 2000
NoConn ~ 7350 1850
NoConn ~ 7350 1700
...
U 1 1 4BCD78F2
P 3700 1300
F 0 "#PWR12" H 3700 1300 30  0001 C C
...
U 1 1 4BCC77E8
P 6850 3550
F 0 "#PWR18" H 6850 3650 30  0001 C C
...
U 1 1 4BCC77BE
P 7350 4450
F 0 "#PWR17" H 7350 4550 30  0001 C C
...
U 1 1 4BCC77B6
P 8350 6250
F 0 "#PWR16" H 8350 6350 30  0001 C C
...
U 1 1 4BCC7771
P 3150 1100
F 0 "#PWR15" H 3150 1200 30  0001 C C
...
U 1 1 4BCC776C
P 2600 2400
F 0 "#PWR14" H 2600 2500 30  0001 C C
...
U 1 1 4BCC7763
P 4300 3900
F 0 "#PWR13" H 4300 4000 30  0001 C C
...
U 1 1 4B279141
P 4300 4700
F 0 "R1" V 4380 4700 50  0000 C C
F 1 "1K" V 4300 4700 50  0000 C C
	1    4300 4700
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 4B2128A7
P 10100 6950
F 0 "#PWR11" H 10100 6950 30  0001 C C
...
U 1 1 4B21289D
P 8400 6950
F 0 "#PWR10" H 8400 6950 30  0001 C C
...
U 1 1 4B21288C
P 7550 6950
F 0 "#PWR9" H 7550 6950 30  0001 C C
...
U 1 1 4B2127D2
P 7250 3100
F 0 "#PWR8" H 7250 3100 30  0001 C C
...
U 1 1 4B052057
P 7700 4650
F 0 "#PWR7" H 7700 4650 30  0001 C C
...
U 1 1 4B051F79
P 2650 2550
F 0 "#PWR6" H 2650 2550 30  0001 C C
...
U 1 1 47B1984C
P 9750 4700
F 0 "#PWR5" H 9750 4700 30  0001 C C
...
U 1 1 45F6A904
P 4300 5000
F 0 "#PWR4" H 4300 5000 30  0001 C C
...
U 1 1 45F6A8F9
P 4300 4150
F 0 "D1" H 4300 4250 50  0000 C C
F 1 "RED" H 4300 4050 50  0000 C C
	1    4300 4150
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 453CDC95
P 2100 1600
F 0 "#PWR3" H 2100 1600 30  0001 C C
...
U 1 1 453CA2A4
P 6600 2700
F 0 "#PWR2" H 6600 2700 30  0001 C C
